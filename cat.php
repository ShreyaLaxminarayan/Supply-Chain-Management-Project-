...
<div class="col-md-12">
  ...
  <div class="col-sm-12">
    <div class="panel panel-default panel-table">
        <div class="panel-heading"><strong>CATEGORY TABLE</strong></div>
            ...
            <span id="srch_cat">
                <table class="table table-condensed table-hover table-bordered table-striped">
                    ...
                    <tbody style="color:black;">
                        ...
                        foreach ($data as $row) {
                            $s++;
                            $quantity = rand(1, 100); // Generate a random quantity for each row
                            echo "<tr>
                                    <td><center>$s</center></td>
                                    <td>" . ucwords($row['cat_name']) . "</td>
                                    <td>" . ucwords($row['cat_des']) . "</td>
                                    <td>$quantity</td>
                                    <td><a href='delete-cat.php?cat_id=" . $row["cat_id"] . "' class='btn btn-space md-trigger btn-danger' style='float: right;'><i class='icon icon-left mdi mdi-close-circle'></i></a></td>
                                </tr>";
                        }
                        ?>
                    </tbody>
